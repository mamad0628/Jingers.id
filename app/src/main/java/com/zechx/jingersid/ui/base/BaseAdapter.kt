package com.zechx.jingersid.ui.base
...
@BindingAdapter("data")
fun <T> recylerViewData(recylerView: RecyclerView, data: T?) {
    if (recylerView.adapter is BindableAdapter<*>) {
        (recylerView.adapter as BindableAdapter<T>).setData(data)
    }
}